...
<body><div class="header1">
    ...
    <div class="container">
        ...
        <?php                                                                                          
            ...
            $select="select * from item1 where status='Pending' order by id desc"; 
            // where mo='$un'";
                ...
                <div class="contain">
                        ...
                        <div>
                            <form action="Status1.php" method="get">
                                <button class="b1" name="submit" type="submit"><a href="Pending_full.php? selectid=<?php echo $id;?>">see more</a></button>
                            </form>
                        </div>
                </div>
